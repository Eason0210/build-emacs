...
if [[ "$1" =~ ^[a-zA-Z0-9]{7,40}$ ]]; then
    ...
    git checkout master
    git pull
elif [[ "$1" = "master" || "$1" = "feature/igc3" || "$1" = "emacs-30" ]]; then
